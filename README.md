...
You can then execute your native executable with: `./target/ms-validate-1.0.0-SNAPSHOT-runner`
...
- RESTEasy Reactive ([guide](https://quarkus.io/guides/resteasy-reactive)): A JAX-RS implementation utilizing build time
  ...
  that depend on it.
- SmallRye Fault Tolerance ([guide](https://quarkus.io/guides/microprofile-fault-tolerance)): Build fault-tolerant
  network services
